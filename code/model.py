...
# import unet.unet_model as unet_model ;;; UNET IS BETTER?
...
class AmpSimulator(object):
    ...
    def __init__(self, config, name):
        ...
        '''
        super(AmpSimulator, self).__init__()
        self.config = config
    ...
    def build_model(self):
        ...
        if self.config['data']['type'] == 'mel':
            self.G = nn.DataParallel(GeneratorMel(self.num_emotions))
        else:
            self.G = nn.DataParallel(GeneratorRaw(self.num_emotions))
